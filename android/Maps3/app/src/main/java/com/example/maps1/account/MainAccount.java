    ...
    private void loadProfileData() {
        new Thread(() -> {
            try {
                ...
                java.net.URL url = new java.net.URL("https://api.aroundme.pp.ua/api/User/get");
    ...
    private void loadUserReviews() {
        new Thread(() -> {
            try {
                ...
                java.net.URL url = new java.net.URL("https://api.aroundme.pp.ua/api/Review/get-by-user?skip=0&take=10");
                javax.net.ssl.HttpsURLConnection conn = (javax.net.ssl.HttpsURLConnection) url.openConnection();
    ...
    private void loadPlaceInfoAndBind(String gmapId, TextView nameView, TextView addressView, TextView ratingView, Button goToPlaceButton1, int placeId) {
        ...
        new Thread(() -> {
            try {
                ...
                String urlStr = "https://api.aroundme.pp.ua/api/Place/info/?placeId=" + gmapId;
