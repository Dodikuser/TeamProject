...
public class PlaceUtils {
    public static void fetchPlaceDetails(Context context, String placeId, Consumer<MyPlace> callback) {
        new Thread(() -> {
            try {
                java.net.URL url = new java.net.URL("https://api.aroundme.pp.ua/api/Place/info/?placeId=" + placeId);
    ...
    public static void addPlaceToHistory(Context context, String token, String placeId) {
        new Thread(() -> {
            try {
                java.net.URL url = new java.net.URL("https://api.aroundme.pp.ua/api/history/places/action?historyAction=Add");
